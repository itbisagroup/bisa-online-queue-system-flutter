...
class AudioPlayerWav {
  ...
  Future<void> play(String assetPath) async {
    ...
    final openResult = mciSendString(
        ...
        0);
    if (openResult != 0) {
     _logApp.writeLog('Failed to open audio. Error code: $openResult');
    ...
    if (lengthResult != 0) {
     _logApp.writeLog('Failed to get audio length. Error code: $lengthResult');
    ...
    if (playResult != 0) {
     _logApp.writeLog('Failed to play audio. Error code: $playResult');
